         ...
         <div className={styles.gameBlock}>
            <div className={styles.storeBlock}>
               ...
               {gameState === GameState.GAME_OVER ? (
                  <button onClick={playAgainHandler} className={styles.gameButton}>
                     Play Again
                  </button>
               ) : (
                  <button onClick={pauseButtonHandler} className={styles.gameButton}>
            ...
            {gameState === GameState.GAME_OVER && (
               <div className={styles.endGameTitle}>GAME OVER</div>
            )}
         </div>
      </div>
   )
