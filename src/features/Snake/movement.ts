...
export const willSnakeHitTheFood = ({foodPosition, snakeHeadPosition, direction}: WillSnakeHitTheFoodArgs) => {
    switch (direction) {
        case Direction.UP:
           return ( foodPosition.x===snakeHeadPosition.x &&
                snakeHeadPosition.y-SEGMENT_SIZE===foodPosition.y)
        case Direction.DOWN:
           return ( foodPosition.x===snakeHeadPosition.x &&
                snakeHeadPosition.y+SEGMENT_SIZE===foodPosition.y)
        case Direction.RIGHT:
            return ( foodPosition.y===snakeHeadPosition.y &&
